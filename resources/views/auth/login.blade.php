<x-guest-layout>
    ...
    <section class="relative bg-gray-50 dark:bg-gray-900">
        <div class="absolute inset-0 z-0">
            <img src="{{asset('storage/slider_imgs/maldives.jpg')}}" alt="Background Image" class="object-cover w-full h-full">
            ...
            <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
                <div
                    ...
                    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <form class="space-y-4 md:space-y-6" action="{{ route('account.login') }}" method="POST">
                            @csrf
                            <div>
                                <label for="email"
