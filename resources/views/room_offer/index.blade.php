                                ...
                                <tbody>
                                    @foreach ($room_offers as $room_offer)
                                        <tr class="border-b dark:border-gray-700">
                                            <td class="px-4 py-3">{{ $room_offer->id }}</td>
                                            <th scope="row"
                                                class="px-4 py-3 font-medium text-gray-900 whitespace-nowrap dark:text-white">
                                                {{ $room_offer->service }}
                                            </th>
                                            <td class="px-4 py-3 flex items-center justify-end">
                                                <button id="{{ $room_offer->id }}-dropdown-button"
                                                    data-dropdown-toggle="{{ $room_offer->id }}-dropdown"
                                                ...
                                                <div id="{{ $room_offer->id }}-dropdown"
                                                    class="hidden z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600">
                                                    <ul class="py-1 text-sm text-gray-700 dark:text-gray-200"
                                                        aria-labelledby="{{ $room_offer->id }}-dropdown-button">
                                                        <li>
                                                            <a href="{{ route('roomoffers.show', $room_offer->id) }}"
                                                                class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Show</a>
                                                        </li>
                                                        <li>
                                                            <a href="{{ route('roomoffers.edit', $room_offer->id) }}"
                                                                class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">Edit</a>
                                                        </li>
                                                    </ul>
                                                    <a id="deleteButton" data-modal-target="deleteModal"
                                                        data-modal-toggle="deleteModal" data-record-id="1"
                                                        data-record-id="{{ $room_offer->id }}"
                                                        data-action="{{ route('roomoffers.destroy', $room_offer->id) }}"
        ...
        <div id="createModal" tabindex="-1" aria-hidden="true"
            ...
            <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                ...
                <div class="relative p-4 bg-white rounded-lg shadow dark:bg-gray-800 sm:p-5">
                    ...
                    @endif
                    <form id="createForm" action="{{ route('roomoffers.store') }}" method="POST"
